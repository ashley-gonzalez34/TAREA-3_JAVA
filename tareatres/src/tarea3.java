...
public class tarea3 {
    ...
    private static int [][] sumafi = new  int[5][6];
    ...
    // Imprimir la Matriz
     ...
     // lo que hace es buscar la cantidad que querramos saber   de los datos que se ingresaron a la tablaa
     ...
     public static void main(String[] args) {
       ...
       System.out.println("***MENU ***\n"
               ...
               + "4. Desea cambiar datos? \n"
               + "5. Busqueda de datos !! \n"
               + "6. Quieres ver la Tabla?\n"
               + "7. Salir");
